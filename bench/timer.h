...
// Modified work Copyright (C) 2018 Arun Ramachandran <ramachandran.arun@outlook.com>
//
// This Source Code Form is subject to the terms of the Mozilla
// Public License v. 2.0. If a copy of the MPL was not distributed
// with this file, You can obtain one at http://mozilla.org/MPL/2.0/.

#ifndef FASTMATRIX_BENCH_TIMER_H
#define FASTMATRIX_BENCH_TIMER_H
...
# ifndef NOMINMAX
#   define NOMINMAX
#   define FASTMATRIX_BT_UNDEF_NOMINMAX
# endif
# ifndef WIN32_LEAN_AND_MEAN
#   define WIN32_LEAN_AND_MEAN
#   define FASTMATRIX_BT_UNDEF_WIN32_LEAN_AND_MEAN
# endif
# include <windows.h>
...
#ifdef FASTMATRIX_BT_UNDEF_NOMINMAX
# undef FASTMATRIX_BT_UNDEF_NOMINMAX
# undef NOMINMAX
#endif

#ifdef FASTMATRIX_BT_UNDEF_WIN32_LEAN_AND_MEAN
# undef FASTMATRIX_BT_UNDEF_WIN32_LEAN_AND_MEAN
# undef WIN32_LEAN_AND_MEAN
#endif

#endif // FASTMATRIX_BENCH_TIMER_H
